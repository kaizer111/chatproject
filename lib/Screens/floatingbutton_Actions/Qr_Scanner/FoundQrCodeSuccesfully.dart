          ...
          Center(
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  const Text("Scanned User", style: TextStyle(fontSize: 45,fontFamily: "fira",color: Colors.white),),
                  ...
                  FutureBuilder(
                    ...
                    builder: (context,AsyncSnapshot<UserModel> snapshot) {
                      ...
                      child: Text(snapshot.data!.name, style: const TextStyle(fontSize: 16,color: Colors.white),));
                      }
                      else{
          ...
          Center(
            child: Padding(
              ...
              child: MaterialButton(
                ...
                child: const Text("Create Chatroom",style: TextStyle(
                            fontSize: 19,)),
                onPressed: () async{
                  final nav = Navigator.of(context);
                await createChatroom(widget.value);
